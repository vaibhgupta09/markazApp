            ...
            <View style={styles.container}>
                    ...
                    <FlatList
                        ...
                        contentContainerStyle={{marginBottom:120}}
                                ...
                                <Text style={{fontSize:20,color:'grey',fontWeight:'bold',marginTop:5,marginLeft:10}}>Nissan Petrol 2005</Text>
                                </View>
                                ...
                                <View style={{width:'35%',backgroundColor:'#89898989',borderRadius:8,justifyContent:'center',alignItems:'center',height:'95%',marginTop:'2%'}}>
                                  ...
                                  <View style={{width:'40%',height:"100%"}}>
                                                   ...
                                                   <Text style={{marginLeft:10,fontSize:20,color:'grey',fontWeight:'bold',marginTop:10}}>120,000</Text>
                                                   <Text style={{marginLeft:10,fontSize:14,color:'grey',marginTop:1}}>Current price</Text>
                                                   <Text style={{marginLeft:10,fontSize:20,color:'grey',fontWeight:'bold',marginTop:10}}>203</Text>
