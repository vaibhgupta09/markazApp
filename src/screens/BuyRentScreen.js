...
import {
    Platform,
    StyleSheet, PixelRatio,ScrollView,
         ...
         <ScrollView>
            <View style={styles.container}>
                    ...
                    <View style={{ width: width, height: 50 ,flexDirection:'row'}}>
                        ...
                        <TouchableOpacity onPress={()=>Actions.push('LoginScreen')} style={{width:'45%',height:'100%',justifyContent:"center",alignItems:'center'}}>
                            ...
                            <TouchableOpacity style={{width:'15%',height:'100%',justifyContent:"center",alignItems:'center'}}>
                                <Image source={Usericon} style={{width:'50%',width:'50%',resizeMode:'contain'}}/>
                    ...
                    <View style={{width:width,height:'15%',flexDirection:'row'}}>
                         <View style={{justifyContent:'center',alignItems:'center',width:'30%',height:'100%'}}>
                             <Image source={car}  style={{width:'80%',height:'80%',resizeMode:'contain'}}/>
                         </View>
                    ...
                    <FlatList
                        ...
                        renderItem={({item}) => 
                         <TouchableOpacity onPress={()=>Actions.push('DetailScreen')} style={{width:width/3,height:150,marginLeft:10,marginBottom:10}}>
                             <View style={{width:'90%',backgroundColor:'#89898989',borderRadius:8,justifyContent:'center',alignItems:'center',height:'50%'}}>

                             <Image source={noimage} style={{width:'50%',height:'40%',resizeMode:'contain'}}/>
                             </View>
                             <View style={{width:'90%',borderRadius:8,justifyContent:'center',height:'50%'}}>
                             <Text style={{fontSize:18,color:'grey',fontWeight:'bold'}}>AED 28,000</Text>
                             <Text style={{fontSize:12,color:'grey'}}>Nissan-Atlima</Text>
                        ...
                        renderItem={({item}) => 
                        <TouchableOpacity onPress={()=>Actions.push('DetailScreen')} style={{width:width,height:180,justifyContent:'center',alignItems:'center'}}>
